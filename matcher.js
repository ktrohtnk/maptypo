...
const TEMPLATES = {
  ...
  'B': [[[0.2, 1.0], [0.2, 0.5], [0.2, 0.0], [0.7, 0.0], [0.9, 0.25], [0.9, 0.4], [0.7, 0.5], [0.2, 0.5]], [[0.2, 0.5], [0.8, 0.5], [1.0, 0.75], [1.0, 0.9], [0.8, 1.0], [0.2, 1.0]]],
  'C': [[[0.9,0.2], [0.5,0.0], [0.1,0.2], [0.1,0.8], [0.5,1.0], [0.9,0.8]]],
  'D': [[[0.2, 1.0], [0.2, 0.0], [0.8, 0.0], [1.0, 0.3], [1.0, 0.7], [0.8, 1.0], [0.2, 1.0]]],
  ...
  'P': [[[0.2, 1.0], [0.2, 0.5], [0.2, 0.0], [0.8, 0.0], [1.0, 0.25], [1.0, 0.45], [0.8, 0.5], [0.2, 0.5]]],
  'Q': [[[0.5,0.0], [0.9,0.2], [1.0,0.5], [0.9,0.8], [0.5,1.0], [0.1,0.8], [0.0,0.5], [0.1,0.2], [0.5,0.0]], [[0.6,0.7], [1.0,1.0]]],
  'R': [[[0.2, 1.0], [0.2, 0.5], [0.2, 0.0], [0.8, 0.0], [1.0, 0.25], [1.0, 0.45], [0.8, 0.5], [0.2, 0.5]], [[0.5, 0.5], [1.0, 1.0]]],
  ...
  // ♡ heart — one continuous pen-stroke: up left bump, over the notch, up right bump, down to the point
  '♡': [[[0.5, 1.0], [0.1, 0.5], [0.0, 0.3], [0.1, 0.1], [0.3, 0.0], [0.5, 0.2], [0.7, 0.0], [0.9, 0.1], [1.0, 0.3], [0.9, 0.5], [0.5, 1.0]]],
  '♥': [[[0.5, 1.0], [0.1, 0.5], [0.0, 0.3], [0.1, 0.1], [0.3, 0.0], [0.5, 0.2], [0.7, 0.0], [0.9, 0.1], [1.0, 0.3], [0.9, 0.5], [0.5, 1.0]]],
